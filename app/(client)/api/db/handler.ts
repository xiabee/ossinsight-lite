...
/**
 * Executes one SQL statement against a configured database.
 *
 * Split out of the POST route so additional transports (GET with the SQL
 * encoded in the path, for CDNs that strip query strings and forbid POST)
 * can reuse the same logic.
 */
export async function handleDbQuery (req: NextRequest, name: string, sql: string) {
